...
const projects = [
  ...
  },
  {
    ...
    results: [
      ...
      "API 연동·상태관리·상담 화면 개선을 통해 실무형 프론트엔드 구현 경험을 쌓았습니다.",
    ],
  },
  {
  ...
  },
  {
    ...
    title: "화성시 대학(원)생 도시데이터 연구공모전",
    englishTitle: "Hwaseong Urban Data Research Competition",
    badge: "데이터 분석",
    meta: ["2025.03 ~ 2025.05", "Urban Data", "NDVI", "Visualization"],
    thumbnail: "/images/projects/화성도시데이터.png",
    thumbnailFit: "contain",
    description:
      "위성영상 전처리와 인구·탄소배출 데이터 활용을 통해 화성시의 녹지 확충 우선순위 분석을 제안한 도시데이터 공모전 프로젝트입니다.",
    ...
    architecture: [
      ...
      "분석 결과를 표와 정책 지원 지도로 시각화하는 방안을 제안했습니다.",
    ],
    implementation: [
      "위성영상 NDVI와 화성시 행정 데이터를 수집·정제하고 지역 단위로 결합했습니다.",
      "탄소 배출량과 인구 데이터를 반영한 녹지 우선순위 지표를 설계했습니다.",
      "지역별 우선순위 표와 정책 지원 지도의 구성 방향을 제안했습니다.",
    ],
    results: [
      "데이터 기반 녹지 조성 우선순위 분석 방법을 제안했습니다.",
      "지역별 환경 부담을 비교하는 지표와 시각화 예시를 정리했습니다.",
  ...
  },
  {
    ...
    description:
      "Steel Plates Faults 데이터셋의 클래스 불균형과 변수 관계를 분석하고, 샘플링·규제·앙상블 실험으로 결함 분류 전략을 비교한 프로젝트입니다.",
    ...
    implementation: [
      ...
      "최종적으로 9개 피처를 제거 대상으로 선정하고 모델별 성능을 비교했습니다.",
    ],
    results: [
      "27개 입력 변수 중 9개를 제거 대상으로 선정해 18개 변수 구성을 정리했습니다.",
...
데이터 분석부터 AI 서비스 기획·개발, 배포 자동화와 서비스 운영·유지보수까지 경험하며, 현업의 문제를 이해하고 데이터와 AI를 활용해 실질적인 업무 변화를 만드는 서비스를 기획하고 구현해왔습니다.
            </p>
